...
public class DODisplayTagData implements PaginatedList, Serializable {
	...
	private List<DynamicObjectDTO> pageItems;
	...
	public DODisplayTagData() {
		this(0, Collections.EMPTY_LIST, "id", "asc", 1, PAGE_SIZE_DEFAULT);
	}

	public DODisplayTagData(long count, List pageItems, String sort, String dir,
	...
	public void setPageItems(List<DynamicObjectDTO> pageItems) {
		this.pageItems = pageItems;
	}
	...
	public List<DynamicObjectDTO> getList() {
		return pageItems;
	}
