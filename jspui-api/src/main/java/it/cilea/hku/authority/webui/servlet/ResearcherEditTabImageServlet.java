...
public class ResearcherEditTabImageServlet extends HttpServlet {
	/** log4j category */
	private static Logger log = Logger
			.getLogger(ResearcherEditTabImageServlet.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse response)
		...
		try {
			context = new Context();
			TableRow row = DatabaseManager.find(context, "model_jdyna_edittab",
