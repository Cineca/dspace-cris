...
<%@page import="it.cilea.hku.authority.model.UserWS"%>
...
<dspace:layout locbar="link" navbar="admin" titlekey="jsp.dspace-admin.userws">
	...
	<form:form commandName="user" method="post">
		...
		<label for="type1"><fmt:message key="jsp.layout.hku.ws.form.type" /></label>
		
		<form:radiobutton cssClass="choosetype" path="type" value="<%= UserWS.TYPENORMAL %>"/>Normal Authentication
		<form:radiobutton cssClass="choosetype" path="type" value="<%= UserWS.TYPESPECIAL %>"/>Token Authentication
