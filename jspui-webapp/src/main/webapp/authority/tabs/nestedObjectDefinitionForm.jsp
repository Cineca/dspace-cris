...
<dspace:layout locbar="link" navbar="admin"
	...
	<form:form commandName="propertiesdefinition" method="post">
		...
		<dyna:text visibility="false" propertyPath="real.descrizione" size="50"
...
<%-- 		<dyna:boolean propertyPath="propertiesdefinition.real.mandatory"
		...
		<div class="dynaClear">
			&nbsp;
						...
						<c:forEach
							items="${propertiesdefinition.real.maschera}"
							var="subtypo" varStatus="i">

							<fieldset><legend><fmt:message
									key="jsp.layout.hku.label.propertiesdefinition.rendering.${subtypo.rendering.triview}" /></legend> 
							
							<dyna:text visibility="false" propertyPath="real.maschera[${i.count - 1}].shortName"
								labelKey="jsp.layout.hku.label.propertiesdefinition.shortName" helpKey="help.jdyna.message.shortName"/>
		
		
							<dyna:text visibility="false" propertyPath="real.maschera[${i.count - 1}].label" size="50"
									labelKey="jsp.layout.hku.label.propertiesdefinition.label" helpKey="help.jdyna.message.label"/>						
							...
							<dyna:boolean propertyPath="real.maschera[${i.count - 1}].repeatable"
									labelKey="jsp.layout.hku.label.propertiesdefinition.repeatable" helpKey="help.jdyna.message.repeatable"/>
							<div class="dynaClear">
								&nbsp;
							</div>
										<c:if
											...
											<fieldset style="width: 90%;"><dyna:text visibility="false"
												propertyPath="real.maschera[${i.count - 1}].rendering.labelHeaderLabel"
											...
											<dyna:text visibility="false"
												propertyPath="real.maschera[${i.count - 1}].rendering.labelHeaderURL"
										...
										<c:if
											...
											<dyna:boolean propertyPath="real.maschera[${i.count - 1}].rendering.showPreview"
											...
											<dyna:text visibility="false" propertyPath="real.maschera[${i.count - 1}].rendering.fileDescription"
											...
											<dyna:text visibility="false" propertyPath="real.maschera[${i.count - 1}].rendering.labelAnchor"
								...
								<dyna:text propertyPath="real.maschera[${i.count - 1}].priority"  helpKey="help.jdyna.message.priority"
				labelKey="jsp.layout.hku.label.propertiesdefinition.priority" size="5" visibility="false"/>
		<div class="dynaClear">
			&nbsp;
		</div>
		...
		<dyna:boolean propertyPath="real.maschera[${i.count - 1}].newline"
				labelKey="jsp.layout.hku.label.propertiesdefinition.newline" helpKey="help.jdyna.message.newline"/>
		<div class="dynaClear">
			&nbsp;
		</div>
				
		<dyna:text propertyPath="real.maschera[${i.count - 1}].labelMinSize"  helpKey="help.jdyna.message.labelMinSize"
				labelKey="jsp.layout.hku.label.propertiesdefinition.labelMinSize" size="5" visibility="false"/>
		<div class="dynaClear">
			&nbsp;
		</div>		
						
		<dyna:text propertyPath="real.maschera[${i.count - 1}].fieldMinSize.col"  helpKey="help.jdyna.message.fieldminsize.col"
				labelKey="jsp.layout.hku.label.propertiesdefinition.fieldminsize.col" size="5" visibility="false"/>
		<div class="dynaClear">
			&nbsp;
		</div>
		
		<dyna:text propertyPath="real.maschera[${i.count - 1}].fieldMinSize.row"  helpKey="help.jdyna.message.fieldminsize.row"
		...
		<div class="dynaClear">
			&nbsp;
				...
				key="jsp.dspace-admin.hku.jdyna-configuration.deletedynamicfield" />"
								href="<%=request.getContextPath()%>/${specificPartPath}/administrator/deleteNestedFieldDefinition.htm?pDId=${subtypo.id}&boxId=${boxId}&tabId=${tabId}">
							<img
