...
<%@page
	import="it.cilea.hku.authority.model.dynamicfield."%>
		...
		<tbody>
			...
			<tr>
				<c:forEach items="${tabList}" var="area">
					...
					<%-- Add here logic to manage change area  --%>				
...
return ""+(public String _elExpression3749fn:length(propertiesDefinitionsInHolder[holder.shortName]) <= );
}1}</c:set>
							<%
							    List<String> parameters = new ArrayList<String>();
																			...
																			parameters
																					.add(((DecoratorProjectPropertiesDefinition) pageContext
							...
							<c:if
								test="${show && (tipologiaDaVisualizzare.class.simpleName eq 'DecoratorGrantPropertiesDefinition')}">
