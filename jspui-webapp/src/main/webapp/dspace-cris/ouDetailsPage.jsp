...
<c:set var="dspace.layout.head" scope="request">
    ...
    <script type="text/javascript"><!--
    	...
    	var ajaxurltabs = "<%=request.getContextPath()%>/cris/ou/loadTabs.htm";
    	var ajaxurlnavigation = "<%=request.getContextPath()%>/cris/ou/loadNavigation.htm";
...
<div id="content">
<h1><fmt:message key="jsp.layout.ou.detail.title-first" /> ${entity.sourceID}</h1>
<div>&nbsp;</div>
<table align="center" class="miscTable">
