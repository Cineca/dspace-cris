...
<dspace:layout locbar="link" navbar="admin" titlekey="jsp.dspace-admin.do-list">
	...
	<c:remove var="messages" scope="session" />
		...
		<display:table name="${dto}" cellspacing="0" cellpadding="0" 
			...
			<display:column headerClass="uuid" titleKey="jsp.layout.table.cris.admin-list.uuid" property="uuid" url="/cris/do/details.htm" paramId="id" paramProperty="id" sortable="true" />										
			<display:column headerClass="sourceID" class="sourceID" titleKey="jsp.layout.table.cris.admin-list.sourceID" property="sourceID" url="/cris/do/details.htm" paramId="sourceID" paramProperty="sourceID" sortable="true"/>		
