<c:set var="link">${contextPath}/cris/stats/community.html?handle=${data.object.handle}</c:set>
...
<hr />
<div class="stats-tab<c:if test="${type ne 'community' && type ne 'collection' && type ne 'item' && type ne 'bitstream'}"> stats-tab-current </c:if>"><a href="${link}"><fmt:message key="view.stats-community.selectedObject.page.title" /></a></div>
<div class="stats-tab<c:if test="${type eq 'community'}"> stats-tab-current </c:if>"><a href="${link}&amp;type=community"><fmt:message key="view.stats-community.top.community.page.title" /></a></div>
<div class="stats-tab<c:if test="${type eq 'collection'}"> stats-tab-current </c:if>"><a href="${link}&amp;type=collection"><fmt:message key="view.stats-community.top.collection.page.title" /></a></div>
<div class="stats-tab<c:if test="${type eq 'item'}"> stats-tab-current </c:if>"><a href="${link}&amp;type=item"><fmt:message key="view.stats-community.top.item.page.title" /></a></div>
<div class="stats-tab<c:if test="${type eq 'bitstream'}"> stats-tab-current </c:if>"><a href="${link}&amp;type=bitstream"><fmt:message key="view.stats-community.top.bitstream.page.title" /></a></div>
<hr />
<div class="box">
